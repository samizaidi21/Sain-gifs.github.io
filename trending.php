...
<body>
    <nav>
        <div class="navbar navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="trending.php">Trending</a>        </div>
    </nav>
...
$url = file_get_contents("https://api.giphy.com/v1/gifs/trending?api_key=BUoG03BQWWU12bffUrapMZcWA9qOqRaN&limit=25&rating=g");
